...
from data_generator import SiameseSequence
...
ss = SiameseSequence(x_set=x, y_set=y, batch_size=batch_size, num_class=class_num, data_process_func=ds.read_batch)
ss_valid = SiameseSequence(x_test, y_test, batch_size=batch_size, num_class=class_num,
